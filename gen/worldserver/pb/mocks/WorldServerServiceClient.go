...
func (_m *WorldServerServiceClient) AddExistingItemToPlayer(ctx context.Context, in *pb.AddExistingItemToPlayerRequest, opts ...grpc.CallOption) (*pb.AddExistingItemToPlayerResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddExistingItemToPlayer")
	}
...
func (_m *WorldServerServiceClient) AddPlayersToBattleground(ctx context.Context, in *pb.AddPlayersToBattlegroundRequest, opts ...grpc.CallOption) (*pb.AddPlayersToBattlegroundResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddPlayersToBattleground")
	}
...
func (_m *WorldServerServiceClient) CanPlayerInteractWithGameObject(ctx context.Context, in *pb.CanPlayerInteractWithGameObjectRequest, opts ...grpc.CallOption) (*pb.CanPlayerInteractWithGameObjectResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CanPlayerInteractWithGameObject")
	}
...
func (_m *WorldServerServiceClient) CanPlayerInteractWithNPC(ctx context.Context, in *pb.CanPlayerInteractWithNPCRequest, opts ...grpc.CallOption) (*pb.CanPlayerInteractWithNPCResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CanPlayerInteractWithNPC")
	}
...
func (_m *WorldServerServiceClient) CanPlayerJoinBattlegroundQueue(ctx context.Context, in *pb.CanPlayerJoinBattlegroundQueueRequest, opts ...grpc.CallOption) (*pb.CanPlayerJoinBattlegroundQueueResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CanPlayerJoinBattlegroundQueue")
	}
...
func (_m *WorldServerServiceClient) CanPlayerTeleportToBattleground(ctx context.Context, in *pb.CanPlayerTeleportToBattlegroundRequest, opts ...grpc.CallOption) (*pb.CanPlayerTeleportToBattlegroundResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CanPlayerTeleportToBattleground")
	}
...
// GetAreaTriggerTeleportDestination provides a mock function with given fields: ctx, in, opts
func (_m *WorldServerServiceClient) GetAreaTriggerTeleportDestination(ctx context.Context, in *pb.GetAreaTriggerTeleportDestinationRequest, opts ...grpc.CallOption) (*pb.GetAreaTriggerTeleportDestinationResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAreaTriggerTeleportDestination")
	}

	var r0 *pb.GetAreaTriggerTeleportDestinationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *pb.GetAreaTriggerTeleportDestinationRequest, ...grpc.CallOption) (*pb.GetAreaTriggerTeleportDestinationResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *pb.GetAreaTriggerTeleportDestinationRequest, ...grpc.CallOption) *pb.GetAreaTriggerTeleportDestinationResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pb.GetAreaTriggerTeleportDestinationResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *pb.GetAreaTriggerTeleportDestinationRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *WorldServerServiceClient) GetMoneyForPlayer(ctx context.Context, in *pb.GetMoneyForPlayerRequest, opts ...grpc.CallOption) (*pb.GetMoneyForPlayerResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetMoneyForPlayer")
	}
...
func (_m *WorldServerServiceClient) GetPlayerItemsByGuids(ctx context.Context, in *pb.GetPlayerItemsByGuidsRequest, opts ...grpc.CallOption) (*pb.GetPlayerItemsByGuidsResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPlayerItemsByGuids")
	}
...
func (_m *WorldServerServiceClient) ModifyMoneyForPlayer(ctx context.Context, in *pb.ModifyMoneyForPlayerRequest, opts ...grpc.CallOption) (*pb.ModifyMoneyForPlayerResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ModifyMoneyForPlayer")
	}
...
func (_m *WorldServerServiceClient) RemoveItemsWithGuidsFromPlayer(ctx context.Context, in *pb.RemoveItemsWithGuidsFromPlayerRequest, opts ...grpc.CallOption) (*pb.RemoveItemsWithGuidsFromPlayerResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for RemoveItemsWithGuidsFromPlayer")
	}
...
func (_m *WorldServerServiceClient) StartBattleground(ctx context.Context, in *pb.StartBattlegroundRequest, opts ...grpc.CallOption) (*pb.StartBattlegroundResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for StartBattleground")
	}
...
func NewWorldServerServiceClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *WorldServerServiceClient {
